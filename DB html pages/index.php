                    ...
                    <div class="col-md-8" style="width: 25%;">
                        <div class="card">
                            ...
                            <div class="content">
                                    <div class="row">
                                        <ul> 
                                            <li><a href="index.php?queryId=1" id="query1">Query1:</a></li>
                                            <li><a href="index.php?queryId=2" id="query2">Query2:</a></li>
                                            <li><a href="index.php?queryId=3" id="query3">Query3:</a></li>
                                            <li><a href="index.php?queryId=4" id="query4">Query4:</a></li>
                                            <li><a href="index.php?queryId=5" id="query5">Query5:</a></li>
                                            <ul>
                                    <div class="clearfix"></div>
                            </div>
                        </div>
